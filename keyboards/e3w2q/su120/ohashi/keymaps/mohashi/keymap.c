...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_qwerty] = LAYOUT(
        KC_TAB,  KC_Q,  KC_W,        KC_E, KC_R, KC_T,    KC_Y, KC_U, KC_I,    KC_O,   LT(_OS, KC_P),   LT(_MS, KC_BSPC), 
        KC_LSFT, KC_A,  KC_S,        KC_D, KC_F, KC_G,    KC_H, KC_J, KC_K,    KC_L,   KC_SCLN,         KC_ENT,    
        KC_LCTL, KC_Z,  GUI_T(KC_X), KC_C, KC_V, KC_B,    KC_N, KC_M, KC_COMM, KC_DOT, LT(_C, KC_SLSH), KC_QUOT,
                                      KC_LALT, KC_SPC,    LT(_N, KC_ENTER), LT(_M, KC_R)
    ),
    [_eucalyn] = LAYOUT(
        LT(_C, KC_TAB),  LT(_OS, KC_Q),  KC_W,        KC_COMM,      KC_DOT,       KC_SLSH,     LT(_C, KC_M), KC_R, KC_D,  KC_Y, KC_P,            LT(_MS, KC_BSPC), 
        CTL_T(KC_SCLN),  KC_A,           KC_O,        KC_E,         KC_U,         KC_I,        KC_G,         KC_T, KC_K,  KC_N, KC_S,            CTL_T(KC_MINS),    
        LSFT_T(KC_ESC),  LT(_MS, KC_Z),  GUI_T(KC_X), LALT_T(KC_C), LT(_M, KC_V), KC_B,        KC_F,         KC_H, KC_J,  KC_L, LT(_C, KC_QUOT), KC_ENT,
        LT(_M, KC_V),    LSFT_T(KC_SPC), LT(_N, KC_ENTER), LT(_M, KC_H)
    ),
    //number
    [_N] = LAYOUT(
    ...
    [_C] = LAYOUT(
        ...
        KC_PGUP, _______,  _______, _______,  KC_LCTL,  _______,     _______, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______,
        _______, _______, _______, _______
    ),
    //mouse1
    [_MS] = LAYOUT(
    ...
    [_OS] = LAYOUT(
        ...
        _______, KC_PSCR, KC_SLCK, KC_PAUSE, KC_INT4, TO(_qwerty),        RGB_MODE_PLAIN, _______,          RGB_MODE_BREATHE, RGB_MODE_RAINBOW, RGB_MODE_SWIRL,    RGB_MODE_SNAKE,
        KC_CAPS, KC_INS,  _______, _______,  KC_INT5, TO(_eucalyn),       RGB_TOG,        RGB_MODE_FORWARD, RGB_MODE_KNIGHT,  RGB_MODE_XMAS,    RGB_MODE_GRADIENT, RGB_MODE_RGBTEST,
        _______, _______, _______, _______
    ),
    //Null
    [_NULL] = LAYOUT(
