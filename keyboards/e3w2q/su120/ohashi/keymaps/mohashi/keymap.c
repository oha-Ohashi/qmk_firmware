...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_eucalyn] = LAYOUT(
        LT(_C, KC_TAB),  LT(_OS, KC_L),  KC_W,        KC_COMM,      KC_DOT,       KC_B,             LT(_C, KC_M), KC_R,  KC_D,  KC_Y,   LT(_OS, KC_P),  LT(_MS, KC_BSPC), 
        CTL_T(KC_SCLN),  KC_A,           KC_O,        KC_E,         KC_U,         KC_I,             KC_G,         KC_T,  KC_K,  KC_N,        KC_S,  CTL_T(KC_MINS),    
        LSFT_T(KC_ESC),  LT(_MS, KC_Z),  GUI_T(KC_X), LALT_T(KC_C), LT(_M, KC_V), LSFT_T(KC_SPC),   LT(_M, KC_F), KC_H,  KC_J,  KC_L,  KC_QUOT,    LT(_C, KC_ENT),
