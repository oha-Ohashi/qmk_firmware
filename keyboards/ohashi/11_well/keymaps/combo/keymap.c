...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //Media
    [_MD] = LAYOUT(
        KC_WH_U, _______, _______, _______, _______,       _______, _______, _______, KC_MUTE, _______, 
        KC_WH_D, _______, _______, _______, _______,       _______, KC_WHOM, KC_WBAK, KC_WFWD, KC_VOLU, 
...
const uint16_t PROGMEM combo_duo[][3] = {
    {KC_A, KC_O, COMBO_END},
    {KC_O, KC_E, COMBO_END},
    {KC_W, KC_B, COMBO_END},
    {KC_K, KC_N, COMBO_END},
    ...
    {KC_E, KC_U, COMBO_END},
    {_______, _______, COMBO_END}

};

combo_t key_combos[COMBO_COUNT] = {
  COMBO(combo_duo[0], LCTL(KC_A)),
  COMBO(combo_duo[1], KC_TAB),
  COMBO(combo_duo[2], KC_Q),
  COMBO(combo_duo[3], KC_ENT),
  COMBO(combo_duo[4], KC_F16),

  COMBO(combo_duo[5], KC_F15),
};
