...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT( /* Base */ 
    SEND_A1,  SEND_B1,  SEND_C1,  SEND_D1,  SEND_E1,     SEND_SA1,  SEND_SB1,  SEND_SC1,  SEND_SD1,  SEND_SE1,  
    SEND_A2,  SEND_B2,  SEND_C2,  SEND_D2,  SEND_E2,     SEND_SA2,  SEND_SB2,  SEND_SC2,  SEND_SD2,  SEND_SE2,  
    SEND_A3,  SEND_B3,  SEND_C3,  SEND_D3,  SEND_E3,     SEND_SA3,  SEND_SB3,  SEND_SC3,  SEND_SD3,  SEND_SE3,  
                        SEND_C4,  SEND_D4,  SEND_E4,     SEND_SA4,  SEND_SB4,  SEND_SC4
  ),
};
