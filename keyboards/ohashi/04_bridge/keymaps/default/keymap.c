...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_eucalyn] = LAYOUT(
        LT(_C, KC_TAB),  LT(_F,KC_DOT), KC_W,         LSFT_T(KC_B), KC_F,        KC_COMM,       ___, ___, LT(_C, KC_M),  KC_R,        LT(_C, KC_D), KC_Y,  KC_P,   LT(_O, KC_BSPC),
        LCTL_T(KC_SCLN), KC_A,          KC_O,         KC_E,         KC_U,        KC_I,          ___, ___, LT(_F,KC_G),   KC_T,        KC_K,         KC_N,  KC_S,   LCTL_T(KC_MINS),
        LSFT_T(KC_ESC),  LCTL_T(KC_Z),  LGUI_T(KC_X), LALT_T(KC_C), LT(_C,KC_V), LSFT_T(KC_SPC),___, ___, LT(_M,KC_ENT), LT(_N,KC_H), KC_J,         KC_L,  KC_Q,   LT(_C, _______)
    ),
    [_N] = LAYOUT(
        KC_GRAVE, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    ___,      ___, _______, KC_PLUS, KC_MINS, KC_ASTR, KC_SLSH, _______, 
        KC_0,     KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    ___,      ___, _______, KC_LSFT, _______, _______, _______, KC_EQL, 
    ...
    //cursor
    [_C] = LAYOUT(
        _______, KC_WH_R, KC_BSPC, KC_UP,   KC_DEL,   KC_ENT,  ___,       ___, ___, ___, ___, _______, _______, KC_VOLU, 
        KC_WH_U, KC_HOME, KC_LEFT, KC_DOWN, KC_RIGHT, KC_END,  ___,       ___, ___, ___, ___, KC_MPRV, KC_MNXT, KC_VOLD,
        KC_WH_D, KC_WH_L, KC_WH_R, _______, _______,  _______, ___,       ___, ___, ___, ___, KC_MPLY, KC_MUTE, _______
    ),
    //O
    [_O] = LAYOUT(
