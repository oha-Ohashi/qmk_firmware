...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_maltron] = LAYOUT(
        ...
        KC_I,           KC_N,          KC_A,         KC_S,        KC_F,              KC_D,          KC_T,   KC_H,         KC_O,   LT(_WF,KC_R),
    ...
    [_qwerty] = LAYOUT(
        KC_TAB,  KC_Q, KC_W, KC_E, KC_R,    KC_T, KC_Y, KC_U, KC_I,    LT(_SK, KC_P), 
        KC_LSFT, KC_A, KC_S, KC_D, KC_F,    KC_G, KC_H, KC_J, KC_K,    KC_SCLN, 
        KC_LCTL, KC_Z, KC_X, KC_C, KC_V,    KC_B, KC_N, KC_M, KC_COMM, KC_SLSH,
        KC_LCTL,     MO(_qwe_N), KC_SPC,    KC_ENT, KC_0,                KC_ESC
    ),
    //qwerty number
    [_qwe_N] = LAYOUT(
        KC_GRAVE, KC_1, _______,  KC_2, KC_3,       _______, _______, _______, _______, _______,
        KC_4,     KC_5, KC_6, KC_7, KC_8,       _______, _______, _______, _______, _______,
    ...
    [_WF] = LAYOUT(
        ...
        _______,                   _______,     _______,       _______,KC_F10,             ___
    ),
    //Media
    [_MD] = LAYOUT(
